...
from .models import Job, Internship, Profile

@admin.register(Job)
class JobAdmin(admin.ModelAdmin):
    list_display = ("id", "title", "company", "location", "posted_at")
    search_fields = ("title", "company", "location")

@admin.register(Application)
class ApplicationAdmin(admin.ModelAdmin):
    list_display = ("id", "applicant_name", "job", "applied_at")
...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ("id", "user", "mobile", "dob")
